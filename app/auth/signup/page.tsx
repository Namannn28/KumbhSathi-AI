...
export default function SignupPage() {
  ...
  async function handleOtpSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (result?.ok) {
        // Update name in DB via client update profile if needed, or directly push
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Create your Pilgrim Account</p>
          </div>
            ...
            <form onSubmit={handleDetailsSubmit} className="space-y-6">
              ...
              <div className="text-center text-sm">
                <p className="text-gray-600">
                  ...
                  <Link href="/auth/login" className="text-sacred-600 font-semibold hover:underline">
                    Login
                  </Link>
                </p>
              </div>
